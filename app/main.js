...
const app_description = 'The unofficial electron app for imgur client';
...
function createMainWindow() {
    ...
    const app_view = new electron.BrowserWindow({
        ...
        x: lastWindowState.x,
        y: lastWindowState.y,
        width: 1400,//lastWindowState.width,
        height: 900,//lastWindowState.height,
    ...
    app_view.loadURL('http://imgur.com');
