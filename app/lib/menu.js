...
var template_win = [{
    ...
    submenu: [{
        ...
        click: function() {
            require('electron').shell.openExternal("https://github.com/mAzurkovic/imgur client/releases/tag/" + app_version);
        }
    }, {
        ...
        label: 'View ' + app_name,
        click: function() {
            require('electron').shell.openExternal("http://github.com");
        }
    }, {
        type: 'separator'
    }, {
